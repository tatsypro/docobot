...
# 🔐 Токены
# Значение токена Telegram-бота можно получить из переменной окружения
# TELEGRAM_TOKEN или указать напрямую
TOKEN = os.getenv("TELEGRAM_TOKEN", "вставь свой токен")
# Второй токен не используется в коде, но оставляем задел на будущее
ANOTHER_TOKEN = os.getenv("ANOTHER_TOKEN", "вставь свой токен")
